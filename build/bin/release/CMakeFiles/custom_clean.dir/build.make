...
CMakeFiles/custom_clean:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=S:\Code\C_++\PayloadCode\proxy_call_shellcode\build\bin\release\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Cleaning up..."
	V:\App\CLion\bin\cmake\win\x64\bin\cmake.exe -E remove -f S:/Code/C_++/PayloadCode/proxy_call_shellcode/build/bin/release/bin/proxy_call.exe
	V:\App\CLion\bin\cmake\win\x64\bin\cmake.exe -E remove -f S:/Code/C_++/PayloadCode/proxy_call_shellcode/build/bin/release/bin/WorkCallback.obj
	V:\App\CLion\bin\cmake\win\x64\bin\cmake.exe -E remove -f S:/Code/C_++/PayloadCode/proxy_call_shellcode/build/bin/release/CMakeFiles/proxy_call.dir/stack_call.c includes/PEB.h utils.c includes/utils.h includes/projstructs.h peb_api.c includes/peb_api.h includes/dllbuff.h.obj
